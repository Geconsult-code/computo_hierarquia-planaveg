...
> **Status: v0.7.2 - classes 1 (Recooperar 2026), 3 (SICAR-regularização), 4 (Outros projetos: embargos PANGIA), 5 (OR),
...
sobreposições* (v0.7.2) [software]. Geoconsult Ltda. Ver `CITATION.cff`.
